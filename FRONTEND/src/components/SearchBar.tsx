...
export function SearchBar({ onSearch, placeholder = 'Search songs...' }: SearchBarProps) {
    ...
    return (
        <div className={`search-bar ${isExpanded ? 'expanded' : 'collapsed'}`}>
            <button className="search-toggle-btn" onClick={toggleExpand} title="Toggle search">
            ...
            <div className="search-input-wrapper">
                ...
                <button className="search-close-mobile-btn" onClick={() => setIsExpanded(false)} title="Close search">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        <line x1="18" y1="6" x2="6" y2="18" />
                        <line x1="6" y1="6" x2="18" y2="18" />
                    </svg>
